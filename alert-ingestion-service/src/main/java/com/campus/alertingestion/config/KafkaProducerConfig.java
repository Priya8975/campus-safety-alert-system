package com.campus.alertingestion.config;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public NewTopic alertEnrichedTopic() {
        return TopicBuilder.name("alert-enriched")
                .partitions(3)
                .replicas(3)
                .build();
    }
    ...
    @Bean
    public NewTopic alertDeliveryStatusTopic() {
        return TopicBuilder.name("alert-delivery-status")
                .partitions(3)
                .replicas(3)
                .build();
    }
